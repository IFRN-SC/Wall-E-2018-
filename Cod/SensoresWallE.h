...
class Sensores: public Calibracao2 {
	...
	public:
	 ...
	 inline bool corEsq_naoVerde(){return corEsquerdo.ehQualquerCoisa(robo.getHSV_Esquerdo());}
	 inline bool corDir_naoVerde(){return corDireito.ehQualquerCoisa(robo.getHSV_Direito());}
