...
void Calibracao2::calculeMedia(){
	mediaDir = calcule.media(maximoPreto_sensor_dir, minimoBranco_sensor_dir); 
	mediaDir2 = calcule.media(maximoPreto_sensor_dir2, minimoBranco_sensor_dir2);
	mediaEsq = calcule.media(maximoPreto_sensor_esq, minimoBranco_sensor_esq);
	mediaEsq2 = calcule.media(maximoPreto_sensor_esq2, minimoBranco_sensor_esq2);
}
