...
class pinagem{
  ...
  #define BOTAO 								45
	...
	#define SENSOR_LINHA_DIREITO2	A0	//Define o pino do sensor de refletancia esquerdo 
	...
	#define SENSOR_COR_ESQ_POWER			3	//Pino analogico A4
	#define SENSOR_COR_DIR_POWER		2	//Pino analogico A5

	

	//A biblioteca possui dois sensores de distancia (Sonares)
	#define SONAR_TRIGGER_FRONTAL	8
	#define SONAR_ECHO_FRONTAL		11
